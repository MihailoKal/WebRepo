...
If a figure has no class set, the image will behave just like a normal markdown image: ![test](/FB.PNG)
...
![alt text](https://i.imgur.com/u9c3UPM.png)

{{< figure src="/FB.PNG" alt="image" caption="figure-normal (without any classes)" >}}
{{< figure src="https://i.imgur.com/Z7kSOaH.jpg" alt="image" caption="figure-big" class="big" >}}
